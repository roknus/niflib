...
const Type NiBSplineCompPoint3Interpolator::TYPE(
	"NiBSplineCompPoint3Interpolator",
	&NiBSplinePoint3Interpolator::TYPE);
...
void NiBSplineCompPoint3Interpolator::Read(
	istream& in,
...
void NiBSplineCompPoint3Interpolator::Write(
	ostream& out,
...
void NiBSplineCompPoint3Interpolator::FixLinks(
