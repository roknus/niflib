...
void BSEffectShaderPropertyFloatController::Read(
	istream& in,
...
void BSEffectShaderPropertyFloatController::Write(
	ostream& out,
...
void BSEffectShaderPropertyFloatController::FixLinks(
