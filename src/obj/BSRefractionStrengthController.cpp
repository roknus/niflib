...
const Type BSRefractionStrengthController::TYPE(
...
void BSRefractionStrengthController::Read(
	istream& in,
...
void BSRefractionStrengthController::Write(
	ostream& out,
...
void BSRefractionStrengthController::FixLinks(
