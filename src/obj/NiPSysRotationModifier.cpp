...
NiPSysRotationModifier::NiPSysRotationModifier()
	: initialRotationSpeed(0.0f)
	, initialRotationSpeedVariation(0.0f)
	, initialRotationAngle(0.0f)
	, initialRotationAngleVariation(0.0f)
	, randomRotSpeedSign(false)
	, randomInitialAxis(false)
{
...
void NiPSysRotationModifier::Write(
	ostream& out,
...
void NiPSysRotationModifier::FixLinks(
