...
const Type BSShaderNoLightingProperty::TYPE(
...
void BSShaderNoLightingProperty::Read(
	istream& in,
...
void BSShaderNoLightingProperty::Write(
	ostream& out,
...
void BSShaderNoLightingProperty::FixLinks(
