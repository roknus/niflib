...
const Type NiPSysFieldMaxDistanceCtlr::TYPE(
...
void NiPSysFieldMaxDistanceCtlr::Read(
	istream& in,
...
void NiPSysFieldMaxDistanceCtlr::Write(
	ostream& out,
...
void NiPSysFieldMaxDistanceCtlr::FixLinks(
