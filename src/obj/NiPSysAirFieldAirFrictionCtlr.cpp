...
const Type NiPSysAirFieldAirFrictionCtlr::TYPE(
...
void NiPSysAirFieldAirFrictionCtlr::Read(
	istream& in,
...
void NiPSysAirFieldAirFrictionCtlr::Write(
	ostream& out,
...
void NiPSysAirFieldAirFrictionCtlr::FixLinks(
