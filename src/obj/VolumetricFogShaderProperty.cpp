...
const Type VolumetricFogShaderProperty::TYPE(
...
void VolumetricFogShaderProperty::Read(
	istream& in,
...
void VolumetricFogShaderProperty::Write(
	ostream& out,
...
void VolumetricFogShaderProperty::FixLinks(
