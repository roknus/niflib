...
const Type NiPSysInitialRotSpeedCtlr::TYPE(
...
void NiPSysInitialRotSpeedCtlr::Read(
	istream& in,
...
void NiPSysInitialRotSpeedCtlr::Write(
	ostream& out,
...
void NiPSysInitialRotSpeedCtlr::FixLinks(
