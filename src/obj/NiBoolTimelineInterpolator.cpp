...
const Type NiBoolTimelineInterpolator::TYPE(
	"NiBoolTimelineInterpolator",
	&NiBoolInterpolator::TYPE);
...
void NiBoolTimelineInterpolator::Read(
	istream& in,
...
void NiBoolTimelineInterpolator::Write(
	ostream& out,
...
void NiBoolTimelineInterpolator::FixLinks(
