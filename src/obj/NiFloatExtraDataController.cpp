...
const Type NiFloatExtraDataController::TYPE(
	"NiFloatExtraDataController",
	&NiExtraDataController::TYPE);
...
void NiFloatExtraDataController::Read(
	istream& in,
...
void NiFloatExtraDataController::Write(
	ostream& out,
...
void NiFloatExtraDataController::FixLinks(
