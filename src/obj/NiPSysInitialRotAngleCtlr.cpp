...
const Type NiPSysInitialRotAngleCtlr::TYPE(
...
void NiPSysInitialRotAngleCtlr::Read(
	istream& in,
...
void NiPSysInitialRotAngleCtlr::Write(
	ostream& out,
...
void NiPSysInitialRotAngleCtlr::FixLinks(
