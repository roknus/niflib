...
const Type NiPSEmitterDeclinationVarCtlr::TYPE(
	"NiPSEmitterDeclinationVarCtlr",
	&NiPSEmitterDeclinationCtlr::TYPE);
...
void NiPSEmitterDeclinationVarCtlr::Read(
	istream& in,
...
void NiPSEmitterDeclinationVarCtlr::Write(
	ostream& out,
...
void NiPSEmitterDeclinationVarCtlr::FixLinks(
