...
const Type NiPSysEmitterDeclinationCtlr::TYPE(
...
void NiPSysEmitterDeclinationCtlr::Read(
	istream& in,
...
void NiPSysEmitterDeclinationCtlr::Write(
	ostream& out,
...
void NiPSysEmitterDeclinationCtlr::FixLinks(
