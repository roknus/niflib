...
const Type NiBSplineCompTransformInterpolator::TYPE(
	"NiBSplineCompTransformInterpolator",
	&NiBSplineTransformInterpolator::TYPE);

NiBSplineCompTransformInterpolator::NiBSplineCompTransformInterpolator()
	: translationBias(0.0f)
	, translationMultiplier(0.0f)
	, rotationBias(0.0f)
...
void NiBSplineCompTransformInterpolator::Read(
	istream& in,
...
void NiBSplineCompTransformInterpolator::Write(
	ostream& out,
...
void NiBSplineCompTransformInterpolator::FixLinks(
...
vector<Key<Quaternion>> NiBSplineCompTransformInterpolator::SampleQuatRotateKeys(
	int npoints,
	int degree) const
{
...
vector<Key<Vector3>> NiBSplineCompTransformInterpolator::SampleTranslateKeys(
	int npoints,
	int degree) const
{
...
vector<Key<float>> NiBSplineCompTransformInterpolator::SampleScaleKeys(int npoints, int degree)
	const
{
