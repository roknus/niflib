...
const Type NiBSplineFloatInterpolator::TYPE(
...
void NiBSplineFloatInterpolator::Read(
	istream& in,
...
void NiBSplineFloatInterpolator::Write(
	ostream& out,
...
void NiBSplineFloatInterpolator::FixLinks(
