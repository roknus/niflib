...
const Type NiPSysFieldAttenuationCtlr::TYPE(
...
void NiPSysFieldAttenuationCtlr::Read(
	istream& in,
...
void NiPSysFieldAttenuationCtlr::Write(
	ostream& out,
...
void NiPSysFieldAttenuationCtlr::FixLinks(
