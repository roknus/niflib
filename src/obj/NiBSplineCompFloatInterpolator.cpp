...
const Type NiBSplineCompFloatInterpolator::TYPE(
	"NiBSplineCompFloatInterpolator",
	&NiBSplineFloatInterpolator::TYPE);
...
void NiBSplineCompFloatInterpolator::Read(
	istream& in,
...
void NiBSplineCompFloatInterpolator::Write(
	ostream& out,
...
void NiBSplineCompFloatInterpolator::FixLinks(
...
{
	vector<float> value;
	if((offset != USHRT_MAX) && splineData && basisData)
