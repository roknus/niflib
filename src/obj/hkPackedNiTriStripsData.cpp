...
void hkPackedNiTriStripsData::Write(
	ostream& out,
...
void hkPackedNiTriStripsData::FixLinks(
...
vector<hkTriangle> hkPackedNiTriStripsData::GetHavokTriangles() const
{
	...
	for(unsigned i = 0; i < triangles.size(); ++i)
	{
		...
		if(t.triangle.v1 != t.triangle.v2 && t.triangle.v2 != t.triangle.v3 &&
		   t.triangle.v1 != t.triangle.v3)
		{
			good_triangles.push_back(t);
		}
	}
