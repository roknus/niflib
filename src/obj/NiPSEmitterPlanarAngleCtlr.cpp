...
const Type NiPSEmitterPlanarAngleCtlr::TYPE(
...
void NiPSEmitterPlanarAngleCtlr::Read(
	istream& in,
...
void NiPSEmitterPlanarAngleCtlr::Write(
	ostream& out,
...
void NiPSEmitterPlanarAngleCtlr::FixLinks(
