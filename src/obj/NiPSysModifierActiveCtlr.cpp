...
const Type NiPSysModifierActiveCtlr::TYPE(
	"NiPSysModifierActiveCtlr",
	&NiPSysModifierBoolCtlr::TYPE);
...
void NiPSysModifierActiveCtlr::Read(
	istream& in,
...
void NiPSysModifierActiveCtlr::Write(
	ostream& out,
...
void NiPSysModifierActiveCtlr::FixLinks(
