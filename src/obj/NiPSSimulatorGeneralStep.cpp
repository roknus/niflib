...
NiPSSimulatorGeneralStep::NiPSSimulatorGeneralStep()
	...
	, growTime(0.0f)
	, shrinkTime(0.0f)
	, growGeneration((unsigned short)0)
	, shrinkGeneration((unsigned short)0)
{
...
void NiPSSimulatorGeneralStep::Read(
	istream& in,
...
void NiPSSimulatorGeneralStep::Write(
	ostream& out,
...
void NiPSSimulatorGeneralStep::FixLinks(
