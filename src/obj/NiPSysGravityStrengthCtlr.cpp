...
const Type NiPSysGravityStrengthCtlr::TYPE(
...
void NiPSysGravityStrengthCtlr::Read(
	istream& in,
...
void NiPSysGravityStrengthCtlr::Write(
	ostream& out,
...
void NiPSysGravityStrengthCtlr::FixLinks(
