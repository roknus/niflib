...
const Type NiPSEmitterPlanarAngleVarCtlr::TYPE(
	"NiPSEmitterPlanarAngleVarCtlr",
	&NiPSEmitterPlanarAngleCtlr::TYPE);
...
void NiPSEmitterPlanarAngleVarCtlr::Read(
	istream& in,
...
void NiPSEmitterPlanarAngleVarCtlr::Write(
	ostream& out,
...
void NiPSEmitterPlanarAngleVarCtlr::FixLinks(
