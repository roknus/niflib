...
const Type NiBSplineTransformInterpolator::TYPE(
	"NiBSplineTransformInterpolator",
	&NiBSplineInterpolator::TYPE);

NiBSplineTransformInterpolator::NiBSplineTransformInterpolator()
	: scale(0.0f)
	, translationOffset((unsigned int)0)
	, rotationOffset((unsigned int)0)
	, scaleOffset((unsigned int)0)
{
...
void NiBSplineTransformInterpolator::Read(
	istream& in,
...
void NiBSplineTransformInterpolator::Write(
	ostream& out,
...
void NiBSplineTransformInterpolator::FixLinks(
...
vector<Key<Quaternion>> NiBSplineTransformInterpolator::SampleQuatRotateKeys(
	int npoints,
	int degree) const
{
...
vector<Key<Vector3>> NiBSplineTransformInterpolator::SampleTranslateKeys(int npoints, int degree)
	const
{
