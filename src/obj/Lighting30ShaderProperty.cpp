...
const Type Lighting30ShaderProperty::TYPE(
	"Lighting30ShaderProperty",
	&BSShaderPPLightingProperty::TYPE);
...
void Lighting30ShaderProperty::Read(
	istream& in,
...
void Lighting30ShaderProperty::Write(
	ostream& out,
...
void Lighting30ShaderProperty::FixLinks(
