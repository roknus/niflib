...
const Type NiPSysEmitterDeclinationVarCtlr::TYPE(
...
void NiPSysEmitterDeclinationVarCtlr::Read(
	istream& in,
...
void NiPSysEmitterDeclinationVarCtlr::Write(
	ostream& out,
...
void NiPSysEmitterDeclinationVarCtlr::FixLinks(
