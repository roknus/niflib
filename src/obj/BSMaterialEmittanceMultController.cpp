...
const Type BSMaterialEmittanceMultController::TYPE(
...
void BSMaterialEmittanceMultController::Read(
	istream& in,
...
void BSMaterialEmittanceMultController::Write(
	ostream& out,
...
void BSMaterialEmittanceMultController::FixLinks(
