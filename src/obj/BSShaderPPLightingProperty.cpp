...
const Type BSShaderPPLightingProperty::TYPE(
	"BSShaderPPLightingProperty",
	&BSShaderLightingProperty::TYPE);

BSShaderPPLightingProperty::BSShaderPPLightingProperty()
	: textureSet(NULL)
	, unknownFloat2(0.0f)
	, refractionPeriod((int)0)
	, unknownFloat4(4.0f)
	, unknownFloat5(1.0f)
{
...
void BSShaderPPLightingProperty::Read(
	istream& in,
...
void BSShaderPPLightingProperty::Write(
	ostream& out,
...
void BSShaderPPLightingProperty::FixLinks(
