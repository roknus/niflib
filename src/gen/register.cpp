...
void RegisterObjects()
{
	...
	ObjectRegistry::RegisterObject(
		...
		bhkBallAndSocketConstraint::Create);
	ObjectRegistry::RegisterObject(
		"bhkBallSocketConstraintChain",
		bhkBallSocketConstraintChain::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiBoolTimelineInterpolator::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiMultiTargetTransformController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiPSysEmitterDeclinationCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysEmitterDeclinationVarCtlr",
		NiPSysEmitterDeclinationVarCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysEmitterInitialRadiusCtlr",
		NiPSysEmitterInitialRadiusCtlr::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiTextureTransformController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiFloatExtraDataController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		AbstractAdditionalGeometryData::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiBlendTransformInterpolator::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiBSplineFloatInterpolator::Create);
	ObjectRegistry::RegisterObject(
		"NiBSplineCompFloatInterpolator",
		NiBSplineCompFloatInterpolator::Create);
	ObjectRegistry::RegisterObject(
		"NiBSplinePoint3Interpolator",
		NiBSplinePoint3Interpolator::Create);
	ObjectRegistry::RegisterObject(
		"NiBSplineCompPoint3Interpolator",
		NiBSplineCompPoint3Interpolator::Create);
	ObjectRegistry::RegisterObject(
		"NiBSplineTransformInterpolator",
		NiBSplineTransformInterpolator::Create);
	ObjectRegistry::RegisterObject(
		"NiBSplineCompTransformInterpolator",
		NiBSplineCompTransformInterpolator::Create);
	ObjectRegistry::RegisterObject(
		"BSRotAccumTransfInterpolator",
		BSRotAccumTransfInterpolator::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiParticleSystemController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiPersistentSrcTextureRendererData::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiPSysFieldAttenuationCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysFieldMaxDistanceCtlr",
		NiPSysFieldMaxDistanceCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysAirFieldAirFrictionCtlr",
		NiPSysAirFieldAirFrictionCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysAirFieldInheritVelocityCtlr",
		NiPSysAirFieldInheritVelocityCtlr::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiPSysInitialRotSpeedVarCtlr::Create);
	ObjectRegistry::RegisterObject("NiPSysInitialRotAngleCtlr", NiPSysInitialRotAngleCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysInitialRotAngleVarCtlr",
		NiPSysInitialRotAngleVarCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysEmitterPlanarAngleCtlr",
		NiPSysEmitterPlanarAngleCtlr::Create);
	ObjectRegistry::RegisterObject(
		"NiPSysEmitterPlanarAngleVarCtlr",
		NiPSysEmitterPlanarAngleVarCtlr::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiLightIntensityController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiArkViewportInfoExtraData::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		BSShaderNoLightingProperty::Create);
	ObjectRegistry::RegisterObject(
		"BSShaderPPLightingProperty",
		BSShaderPPLightingProperty::Create);
	ObjectRegistry::RegisterObject(
		"BSEffectShaderPropertyFloatController",
		BSEffectShaderPropertyFloatController::Create);
	ObjectRegistry::RegisterObject(
		"BSEffectShaderPropertyColorController",
		BSEffectShaderPropertyColorController::Create);
	ObjectRegistry::RegisterObject(
		"BSLightingShaderPropertyFloatController",
		BSLightingShaderPropertyFloatController::Create);
	ObjectRegistry::RegisterObject(
		"BSLightingShaderPropertyColorController",
		BSLightingShaderPropertyColorController::Create);
	ObjectRegistry::RegisterObject(
		"BSNiAlphaPropertyTestRefController",
		BSNiAlphaPropertyTestRefController::Create);
	ObjectRegistry::RegisterObject(
		"BSProceduralLightningController",
		BSProceduralLightningController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		BSDecalPlacementVectorExtraData::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		BSMaterialEmittanceMultController::Create);
	ObjectRegistry::RegisterObject("BSMasterParticleSystem", BSMasterParticleSystem::Create);
	ObjectRegistry::RegisterObject(
		"BSPSysMultiTargetEmitterCtlr",
		BSPSysMultiTargetEmitterCtlr::Create);
	ObjectRegistry::RegisterObject(
		"BSRefractionStrengthController",
		BSRefractionStrengthController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		BSRefractionFirePeriodController::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		BSPackedAdditionalGeometryData::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiPSSimulatorCollidersStep::Create);
	ObjectRegistry::RegisterObject(
		"NiPSSimulatorMeshAlignStep",
		NiPSSimulatorMeshAlignStep::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		NiBSplineCompTransformEvaluator::Create);
	...
	ObjectRegistry::RegisterObject(
		...
		bhkCompressedMeshShapeData::Create);
