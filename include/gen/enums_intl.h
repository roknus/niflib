...
void NifStream(
	BSLightingShaderPropertyShaderType& val,
	istream& in,
	const NifInfo& info = NifInfo());
void NifStream(
	BSLightingShaderPropertyShaderType const& val,
	ostream& out,
	const NifInfo& info = NifInfo());
...
void NifStream(
	SkyrimShaderPropertyFlags1 const& val,
	ostream& out,
	const NifInfo& info = NifInfo());
...
void NifStream(
	SkyrimShaderPropertyFlags2 const& val,
	ostream& out,
	const NifInfo& info = NifInfo());
