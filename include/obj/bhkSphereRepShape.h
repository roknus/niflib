...
public:
	...
	/*!
	 * Get the shape's material (Skyrim version).  This determines the type of noises the object
	 * makes as it collides in Oblivion. \return The Oblivion material used by this collision shape.
	 */
	NIFLIB_API SkyrimHavokMaterial GetSkyrimMaterial() const;

	/*!
	 * Sets the shape's material (Skyrim version).  This determines the type of noises the object
	 * makes as it collides in Oblivion. \param[in] value The new material for this shape to use.
	 */
