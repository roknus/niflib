...
public:
	 ...
	 * \return The rigid body that this object references, or a NULL reference if it does not
	 * reference any.
	 */
	 ...
	 * \param[in] value The new rigid body for this collision object to use, or NULL to clear the
	 * current reference.
	 */
