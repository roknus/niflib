...
public:
	...
	/*!
	 * Retrives the current number of spline control points.  This is usually the number of frames
	 * for animation. \return The number of spline control points.
	 */
	NIFLIB_API unsigned int GetNumControlPoints() const;

	/*!
	 * Sets the number of spline control points.  This is usually the number of frames for
	 * animation. \param[in] value The new number of spline control points.
	 */
