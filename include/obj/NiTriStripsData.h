...
public:
	 ...
	 * \param[in] nvtristrips Whether or not to use the NvTriStrips library from nVidia to generate
	 * triangle strips from the given data.
	 */
	...
	/*!
	 * Used to resize the triangle strips array.  If the new size is smaller, strips at the end of
	 * the array will be deleted. \param n The new size of the triangle strips array. \sa
	 * NiTriStripData::GetStripCount
	 */
	 ...
	 * \param index The index of the triangle strip to retrieve the triangles from.  This is a
	 ...
	 * triangle strip specified by index. \sa NiTriStripData::SetStrip, NiTriStripData::GetTriangles
	 */
	NIFLIB_API vector<unsigned short> GetStrip(int index) const;

	/*!
	 * This is a conveniance function which returns all triangle faces in all triangle strips that
	 * make up this mesh.  It is similar to the ITriShapeData::GetTriangles function. \return A
	 * vector containing all the triangle faces from all the triangle strips that make up this mesh.
	 ...
	 * \param index The index of the triangle strip to set the face data for.  This is a zero-based
	 * index which must be a positive number less than that returned by
	 * NiTriStripsData::GetStripCount. \param in The vertex indices that make up this strip, in
	 * standard OpenGL triangle strip order. \sa NiTriStripData::GetStrip,
	 * NiTriStripData::GetTriangles
	 */
