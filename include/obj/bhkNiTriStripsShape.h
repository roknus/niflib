...
public:
	 ...
	 * \param[in] index The index at which the given NiTriStripsData object will be referenced.
	 * Should be lower than the value set with bhkNiTriStripsShape::SetNumStripsData.
	 */
	 ...
	 * \param[in] index The index at which the given NiTriStripsData object will be referenced.
	 * Should be lower than the value set with bhkNiTriStripsShape::SetNumStripsData. \param[in]
	 * strips The new NiTriStripsData object to be referenced by this shape at the specified index.
	 */
	 ...
	 * \param[in] index The index at which the given OblivionLayer will be referenced.  Should be
	 * lower than the value set with bhkNiTriStripsShape::SetNumDataLayers.
	 */
