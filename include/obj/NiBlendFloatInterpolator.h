...
public:
	 ...
	 * interpolated value. \return The floating point value stored in this object.
	 */
	NIFLIB_API float GetFloatValue() const;

	/*!
	 * Sets the floating point value stored in this object.  Perhaps this is the current
	 * interpolated value. \param[in] value The new floating point value to store in this object.
	 */
