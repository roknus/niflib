...
public:
	 ...
	 * \return True if the texture is stored in an external file, false if it is stored within this
	 * NIF file.
	 */
	NIFLIB_API bool IsTextureExternal() const;

	/*!
	 * Sets a new external file texture.  Removes any existing texture references, whether internal
	 * or external. \param[in] file_name The file name of the external texture.  Often needs to
	 * follow game guidlines to be found.
	 */
	NIFLIB_API void SetExternalTexture(string file_name);

	/*!
	 * Sets a new internal file texture.  Removes any existing texture references, whether internal
	 * or external. \param[in] original_file_name The original file name of the texture.  This may
	 * be optional. \param[in] pixel_data The NiPixelData object that contains the texture image
	 * data.
	 */
	NIFLIB_API void SetInternalTexture(string original_file_name, NiPixelData* pixel_data);

	/*!
	 * Returns either the file name of the external texture, or the original file name of the
	 * internal one. \return The name of the texture file.
	 */
	...
	/*!
	 * Gets the current pixel layout of this texture.  This is the image format, usually the color
	 * depth. \return The pixel layout of this texture.
	 */
	...
	/*!
	 * Gets the current mip map format of this texture.  Specifies whether or not the texture
	 * contains mipmaps which are smaller versions of the texture that will be displayed on far away
	 * objects that use it. \return The current mip map format of this texture.
	 */
	NIFLIB_API MipMapFormat GetMipMapFormat() const;

	/*!
	 * Sets the mip map format of this texture.  Specifies whether or not the texture contains
	 * mipmaps which are smaller versions of the texture that will be displayed on far away objects
	 * that use it. \param[in] n The new mip map format of this texture.
	 */
	NIFLIB_API void SetMipMapFormat(MipMapFormat n);

	/*!
	 * Gets the current alpha format of this texture.  Specifies whether and how the texture uses
	 * alpha transparency. \return The current alpha format of this texture.
	 */
	NIFLIB_API AlphaFormat GetAlphaFormat() const;

	/*!
	 * Sets the alpha format of this texture.  Specifies whether and how the texture uses alpha
	 * transparency. \param[in] n The new alpha format of this texture.
	 */
