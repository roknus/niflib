...
public:
	...
	/*!
	 * Sets the current motion system for this rigid body.  Seems to override motion quality when
	 * set to keyframed. \return The current motion system setting of this rigid body.
	 */
	NIFLIB_API MotionSystem GetMotionSystem() const;

	/*!
	 * Gets the current motion system of this rigid body.  Seems to override motion quality when set
	 * to keyframed. \param[in] value The new motion system setting for this rigid body.
	 */
	NIFLIB_API void SetMotionSystem(MotionSystem value);

	/*!
	 * Sets the quality of the calculations used to detect collisions for this object.  Essentially,
	 * the faster the object goes, the higher quality of motion it will require. \return The current
	 * motion quality setting of this rigid body.
	 */
	NIFLIB_API MotionQuality GetQualityType() const;

	/*!
	 * Gets the quality of the calculations used to detect collisions for this object.  Essentially,
	 * the faster the object goes, the higher quality of motion it will require. \param[in] value
	 * The new motion quality setting for this rigid body.
	 */
	...
	NIFLIB_API void UpdateMassProperties(
		float density = 1.0f,
		bool solid = true,
		float mass = 0.0f);
