...
public:
	...
	/*!
	 * Retreives the current bilboard mode of this bilboard node.  This determines how it will cause
	 * the node to face the camera. \return The current bilboard mode.
	 */
	NIFLIB_API BillboardMode GetBillboardMode() const;

	/*!
	 * Sets the bilboard mode of this bilboard node.  This determines how it will cause the node to
	 * face the camera. \param[in] value The new bilboard mode.
	 */
