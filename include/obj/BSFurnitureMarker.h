...
public:
	...
	/*!
	 * Retrieves the furniture marker positions.  These are markers that show where the character
	 * will end up if he/she sits or lies on this object. \return The furniture marker positions.
	 */
	NIFLIB_API vector<FurniturePosition> GetFurniturePositions() const;

	/*!
	 * Sets the furniture marker positions.  These are markers that show where the character will
	 * end up if he/she sits or lies on this object. \return The new furniture marker positions.
	 */
