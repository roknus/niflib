...
public:
	...
	/*!
	 * Retrieves the exponent of this spot light.  This describes the distribution of light.  See
	 * glLight in OpenGL. \return The exponent value.
	 */
	NIFLIB_API float GetExponent() const;

	/*!
	 * Sets the exponent of this spot light.  This describes the distribution of light.  See glLight
	 * in OpenGL. \param[in] value The new exponent value.
	 */
