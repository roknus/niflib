...
public:
	...
	/*!
	 * Gets the 3D point value stored in this object.  Perhaps this is the current interpolated
	 * value, the value when posed, or at time index 0. \return The 3D point value stored in this
	 * object.
	 */
	NIFLIB_API Vector3 GetPoint3Value() const;

	/*!
	 * Sets the 3D point value stored in this object.  Perhaps this is the current interpolated
	 * value, the value when posed, or at time index 0. \param[in] value The new 3D point value to
	 ...
	 * \return The NiPosData object that this interpolator should now link to, or NULL to clear the
	 * current one.
	 */
