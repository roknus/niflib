...
public:
	 ...
	 * \param[in] index The index of the node group to return the data for.  This must be >= 0 and <
	 * the result of ABoneLODController::GetNodeGroupCount. \return The specified node group.
	 */
	 ...
	 * \param[in] index The index of the node group to add a node to.  This must be >= 0 and < the
	 * result of ABoneLODController::GetNodeGroupCount. \param[in] node The node to add to the
	 * group.
	 */
	 ...
	 * \param[in] index The index of the node group to remove a node from.  This must be >= 0 and <
	 * the result of ABoneLODController::GetNodeGroupCount. \param[in] node The node remove from the
	 * group.
	 */
	 ...
	 * \param[in] index The index of the node group to assign a list of nodes to.  This must be >= 0
	 * and < the result of ABoneLODController::GetNodeGroupCount. \param[in] group The list of nodes
	 * to assign to the specified node group.
	 */
	NIFLIB_API void SetNodeGroup(int index, const vector<Ref<NiNode>>& group);


	/*!
	 * Removes an entire node group.  This will cause the indices of any subsequent node groups to
	 * shift. \param[in] index The index of the node group to remove.  This must be >= 0 and < the
	 * result of ABoneLODController::GetNodeGroupCount.
	 */
