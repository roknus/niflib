...
public:
	...
	/*!
	 * Gets the current Oblivion layer, which seems to determine the mesh color displayed by the
	 * Oblivion Construction Set. \return The current Oblivion Layer.
	 */
	NIFLIB_API OblivionLayer GetLayer() const;

	/*!
	 * Sets the Oblivion layer, which seems to determine the mesh color displayed by the Oblivion
	 * Construction Set. \param[in] value The new Oblivoin layer to use.
	 */
