...
public:
	...
	/*!
	 * Retrieves the root node of the skeleton that influences this skin.  This is the common
	 * ancestor of all bones and the skin itself. \return The skeleton root.
	 */
	 ...
	 * the NiTriBasedGeom::GenHardwareSkinInfo function should be used. \param[in] n The new
	 * hardware skin partition data object to use, or NULL to clear the existing one.
	 */
