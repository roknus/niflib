...
public:
	...
	/*!
	 * Retrieves the number of partitions that the triangles in the skin are divided into within
	 * this skin partition data object. \return The number of skin partitions.
	 */
	 ...
	 * \param[in] partition The index of the skin partition to get the data for.  Must be >= 0 and <
	 * the result of NiSkinPartition::GetNumPartitions. \return The number of weights per vertex in
	 ...
	 * \param[in] partition The index of the skin partition to get the data for.  Must be >= 0 and <
	 * the result of NiSkinPartition::GetNumPartitions. \return The number of vertices in the
	 * specified partition.
	 */
	NIFLIB_API unsigned short GetNumVertices(int partition) const;

	/*!
	 * Retrieves the the vertex map for a particular partition.  This maps the weight/influence
	 * lists in the submesh to the vertices in the skin shape. \param[in] partition The index of the
	 * skin partition to get the data for.  Must be >= 0 and < the result of
	 * NiSkinPartition::GetNumPartitions. \return The vertex map for the specified partition.
	 */
	NIFLIB_API vector<unsigned short> GetVertexMap(int partition) const;

	/*!
	 * Retrieves the the bone map for a particular partition.  This is a list of bones that affect
	 * this partition by index. \param[in] partition The index of the skin partition to get the data
	 * for.  Must be >= 0 and < the result of NiSkinPartition::GetNumPartitions. \return The bone
	 * map for the specified partition.
	 */
	 ...
	 * \param[in] partition The index of the skin partition to get the data for.  Must be >= 0 and <
	 * the result of NiSkinPartition::GetNumPartitions. \return True if the specified partition has
	 * vertex weights, false otherwise.
	 */
	 ...
	 * \param[in] partition The index of the skin partition to get the data for.  Must be >= 0 and <
	 * the result of NiSkinPartition::GetNumPartitions. \param[in] vertex The index of the vertex to
	 * get the data for.  Must be >= 0 and < the result of NiSkinPartition::GetNumVertices. \return
	 * The vertex weights for the specified vertex of the specified partition.
	 */
	NIFLIB_API vector<float> GetVertexWeights(int partition, int vertex) const;

	/*!
	 * Used to determine whether a particular partition has vertex bone indices.  In other words,
	 * that it has bones influencing it. \param[in] partition The index of the skin partition to get
	 * the data for.  Must be >= 0 and < the result of NiSkinPartition::GetNumPartitions. \return
	 * True if the specified partition has vertex bone indices, false otherwise.
	 */
	 ...
	 * the result of NiSkinPartition::GetNumPartitions. \param[in] vertex The index of the vertex to
	 * get the data for.  Must be >= 0 and < the result of NiSkinPartition::GetNumVertices. \return
	 * The vertex bone indices for the specified vertex of the specified partition.
	 */
	 ...
	 * \param[in] index The index of the triangle strip to retrieve the triangles from.  This is a
	 * zero-based index which must be a positive number less than that returned by
	 * NiTriStripsData::GetStripCount. \return A vector containing all the triangle faces from the
	 * triangle strip specified by index. \sa NiSkinPartition::SetStrip
	 */
	 ...
	 * \param[in] partition The index of the skin partition to get the data for.  Must be >= 0 and <
	 * the result of NiSkinPartition::GetNumPartitions. \return The triangles that make up the
	 * specified partition.
	 */
...
public:
	...
	NIFLIB_API void SetVertexBoneIndices(
		int partition,
		int vertex,
		const vector<unsigned short>& boneList);
	 ...
	 * particular skin partition.
	 * \param[in] partition The specific partition to get the strip count from.
	 * \param[in] index The index of the triangle strip to set the face data for.  This is a
	 * zero-based index which must be a positive number less than that returned by
	 * NiTriStripsData::GetStripCount. \param[in] in The vertex indices that make up this strip, in
	 * standard OpenGL triangle strip order. \sa NiSkinPartition::GetStrip
	 */
