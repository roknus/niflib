...
public:
	...
	/*!
	 * This generates skin data for hardware acceleration.  Specifically, it creates a
	 * NiSkinPartition object based on the current skin weights.  This splits up the mesh into
	 * smaller parts that are affected by fewer bones so that they can be processed by 3D
	 * accelerator hardware. \param[in] max_bones_per_partition The maximum number of bones that can
	 * affect a skin partition, i.e. a sub-mesh generated by chopping up the original mesh.  Proper
	 * value is game dependent. \param[in] max_bones_per_vertex The maximum number of bones that can
	 * affect any one vertex.  Vertices affected by more bones than this will have the bone witht he
	 * smallest affect removed and the remaining bones will be normalized.
	 */
	NIFLIB_API void GenHardwareSkinInfo(
