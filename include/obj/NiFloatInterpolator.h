...
public:
	...
	/*!
	 * Gets the floating point value stored in this object.  Perhaps this is the current
	 * interpolated value, the value when posed, or at time index 0. \return The floating point
	 * value stored in this object.
	 */
	NIFLIB_API float GetFloatValue() const;

	/*!
	 * Sets the floating point value stored in this object.  Perhaps this is the current
	 * interpolated value, the value when posed, or at time index 0. \param[in] value The new
	 * floating point value to store in this object.
	 */
	 ...
	 * \return The NiFloatData object that this interpolator should now link to, or NULL to clear
	 * the current one.
	 */
