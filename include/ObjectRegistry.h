...
public:
	 ...
	 * \param[in] type_name The textual name of the object that will appear in the NIF file.  For
	 * example: "NiNode" \param[in] create_func The Create function of the NiObject that will be
	 * called during file reading to initialize new objects of the types encountered in the file.
	 */
