...
{
	IndexString() {}
	IndexString(const IndexString& ref)
		: std::string((std::string const&)ref)
	{}
	IndexString(const std::string& ref)
		: std::string(ref)
	{}
	IndexString& operator=(const IndexString& ref)
	{
		assign((std::string const&)ref);
		return *this;
	}
	IndexString& operator=(const std::string& ref)
	{
		assign(ref);
		return *this;
	}
...
{
	Char8String() {}
	Char8String(const Char8String& ref)
		: std::string((std::string const&)ref)
	{}
	Char8String(const std::string& ref)
		: std::string(ref)
	{}
	Char8String& operator=(const Char8String& ref)
	{
		assign((std::string const&)ref);
		return *this;
	}
	Char8String& operator=(const std::string& ref)
	{
		assign(ref);
		return *this;
	}
